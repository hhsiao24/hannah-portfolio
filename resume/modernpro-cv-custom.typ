...
#let date-colour = black
#let primary-colour = black
#let headings-colour = black
#let subheadings-colour = black
#let content-line-height = 0.5em // Default is 0.65em
#let content-line-spacing = 0.5em // Default is 1.2em
...
#let section(title) = {
  text(11pt, fill: headings-colour, weight: "bold")[
    #upper[#title]
    #v(-6pt)
    #line(length: 100%)
    #v(-6pt)
...
// Education part
#let education(institution: "", major: "", date: "", location: "", description: "", gpa: "") = {
  set par(leading: content-line-height, spacing: content-line-spacing)
  ...
  text(11pt, style: "italic", fill: subheadings-colour)[#major ]
  h(1fr)
  if gpa != "" {
    text(11pt, fill: subheadings-colour, style: "italic")[GPA: #gpa]
  }
...
// Projects
#let project(title: "", date: "", info: "", caption: "", tools: "") = {
  set par(leading: content-line-height, spacing: content-line-spacing)
  text(11pt, fill: subheadings-colour, weight: "semibold")[#title]
  if tools != "" {
    [ | ]
    text(11pt, style: "italic", fill: subheadings-colour, weight: "regular")[#tools \ ]
  } else {
    [ \ ]
  }
  text(11pt, style: "italic", fill: subheadings-colour)[#caption]
  if info != [] or info != "" {
...
// Job title
#let job(position: "", institution: "", location: "", date: "", description: "", tools: "") = {
  set par(leading: content-line-height, spacing: content-line-spacing)
  if (position != "") {
  ...
  text(11pt, style: "italic", fill: subheadings-colour)[#institution]
  h(1fr)
  text(11pt, style: "italic", fill: headings-colour, weight: "regular")[#date \ ]
  if description != [] or description != "" {
    text(11pt, fill: primary-colour, weight: "regular")[#description]
...
#let cv-double(
  ...
  set text(font: font-type, weight: "regular", line-spacing: 0.5em)
  set cite(form: "full")
